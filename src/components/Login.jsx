    ...
    <div className='flex flex-col items-center p-2 w-84 justify-center'>
        ...
        <div className="flex flex-row items-center justify-between px-2 rounded-t-lg w-full">
            ...
            <div className="flex flex-row items-center w-full">
                <h1 className='w-full text-center text-2xl font-bold text-blue-400'>Login</h1>
            </div>
        </div>
        ...
        <div className="w-full">
            <button className='w-full py-2 px-4 font-bold text-white bg-blue-400 rounded-lg mt-5'>Login</button>
        </div>
